...
function Projects() {
  ...
  return (
    ...
    >
      ...
      {/* Floating Particles */}
      {particles.map((particle: Particle, i: number) => (
        <motion.div
          key={i}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative z-20 w-full max-w-[1450px] px-8 flex flex-col items-center"
      >
        {/* Heading */}
        <h2 className="text-5xl font-bold tracking-[0.45em] text-blue-400 drop-shadow-[0_0_25px_rgba(139,92,246,0.8)]">
          PROJECTS
        </h2>

        <div className="mt-20 flex items-center justify-center gap-12 w-full">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {pages[page].map((project, index) => (
                    ...
                    className="w-[500px] min-h-[470px] rounded-3xl border border-violet-500/20 bg-[#0B0B0B] px-10 py-10"
                  >
                    {/* Icon */}
                    ...
                    {/* Project Title */}
                    <h3 className="mt-6 text-center text-3xl font-bold text-violet-400 drop-shadow-[0_0_15px_rgba(96,165,250,0.8)]">
                      {project.title}
                    </h3>

                    {/* Description */}
                    <p className="mt-6 text-center text-[17px] leading-8 text-gray-300">
                      {project.description}
                    </p>

                    {/* Tech Stack */}
                    <p className="mt-7 text-center text-lg font-medium text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.35)]">
                      {project.tech}
                    </p>
                    ...
                    <div className="mt-10 flex justify-center">
                      <a
                        ...
                        className="flex items-center gap-3 text-lg font-semibold text-yellow-400 transition-all duration-300 hover:text-yellow-300 hover:scale-105"
                      >
                        <FaGithub size={26} />
                        <span>GitHub</span>
                      </a>
