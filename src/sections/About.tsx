    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-xl md:text-2xl uppercase tracking-[0.45em] font-semibold text-violet-400 drop-shadow-[0_0_18px_rgba(139,92,246,0.9)]"
        >
          ABOUT
        </motion.p>
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="mt-10 text-4xl md:text-5xl lg:text-6xl font-bold text-white"
        >
          Hi, I'm{" "}
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <h3 className="text-2xl font-semibold text-violet-400 drop-shadow-[0_0_18px_rgba(139,92,246,0.9)]">
            Key Accomplishments
          </h3>

          <div className="mt-8 max-w-3xl mx-auto pl-40 text-left space-y-5">
